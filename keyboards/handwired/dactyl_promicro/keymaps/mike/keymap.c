...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_RAISE] = LAYOUT_6x6(            
        ...
        TD(TD_QUIT),_______,_______,_______,KC_PSCR,_______,                    _______,_______,KC_PGDOWN,KC_PGUP,_______,_______,
        TD(TD_TAB),KC_LGUI,KC_LALT,KC_LSFT,KC_LCTL,_______,                     KC_HOME,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,KC_END,
        _______,LCTL(KC_Z),LCTL(KC_X),LCTL(KC_C),MOUSE,LCTL(KC_V),              _______,_______,KC_WH_D,KC_WH_U,_______,_______,
