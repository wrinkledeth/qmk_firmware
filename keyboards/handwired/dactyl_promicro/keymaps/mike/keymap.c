...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT_6x6(
        ...
        RAISE,  KC_LGUI, LCTL(KC_SLSH), KC_LEFT, KC_RGHT,_______,   _______ , KC_DOWN ,KC_UP,KC_LBRC,KC_RBRC,KC_F2,
    ...
    [_RAISE] = LAYOUT_6x6(
        ...
        _______,_______,_______,_______,KC_PSCR,_______,            _______,_______,KC_PGUP,_______,_______,RESET,
        LALT(LCTL(KC_TAB)),_______,_______,_______,KC_LCTL,_______, KC_HOME,KC_LEFT,KC_DOWN,KC_UP,KC_RIGHT,KC_END,
        _______,_______,_______,_______,_______,_______,            _______,KC_PGDOWN,KC_PGDOWN,_______,_______,_______,
